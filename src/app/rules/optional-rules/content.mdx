...
# Time Contention
Too complex, re-evaluate.  Maybe just make a contested roll?
...
# Multi-Rolls
How to combine multiple attributes, resources, etc??
Just… keep adding everything up? Include difficulty for each part of the action.  Count positive or negative points that affect each action each time it matters.
